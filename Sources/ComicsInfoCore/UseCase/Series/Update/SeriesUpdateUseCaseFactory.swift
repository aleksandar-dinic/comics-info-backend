...
public struct SeriesUpdateUseCaseFactory: UpdateUseCaseFactory, CreateRepositoryBuilder, CharacterUseCaseBuilder, SeriesUseCaseBuilder, ComicUseCaseBuilder {
    ...
    public func makeUseCase() -> SeriesUpdateUseCase {
        SeriesUpdateUseCase(
