//
//  ComicDeleteUseCaseFactoryMockCharacterDeleteUseCaseFactoryMock.swift
...
struct ComicDeleteUseCaseFactoryMock: DeleteUseCaseFactory {
    ...
    func makeUseCase() -> ComicDeleteUseCase {
        ComicDeleteUseCase(
