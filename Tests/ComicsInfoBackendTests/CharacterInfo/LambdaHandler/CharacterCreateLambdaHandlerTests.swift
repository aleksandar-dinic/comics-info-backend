//
//  CharacterCreateLambdaHandlerTests.swift
...
final class CharacterCreateLambdaHandlerTests: XCTestCase, LambdaFactory {
    ...
    func test_whenHandle_responseStatusIsBadRequest() throws {
        // Given
        let sut = CharacterCreateLambdaHandler(context: makeLambdaInitializationContext(logger: logger, on: eventLoop))
